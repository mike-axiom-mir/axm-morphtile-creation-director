...
| Interface Machine | `8294f1aa55bfb184268a50c5b032d3c3027aed72` | canonical-name-bound `view.set` candidate | 2/2 local tests; pinned runtime commits view and same action changes same counter | Prove two concurrent presentations over one value; consume only a core-owned placement contract | presentation placement is `HOLD_PRESENTATION_PLACEMENT_NOT_IN_V04` | No |
